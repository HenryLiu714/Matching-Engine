...
static ::_pb::Metadata file_level_metadata_trademessage_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_trademessage_2eproto[2];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_trademessage_2eproto = nullptr;

const uint32_t TableStruct_trademessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_trademessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022trademessage.proto\"\316\001\n\017NewOrderMessage"
  "\022\020\n\010order_id\030\001 \001(\r\022\017\n\007user_id\030\002 \001(\r\022\016\n\006s"
  "ymbol\030\003 \001(\t\022\030\n\004side\030\004 \001(\0162\n.Direction\022\030\n"
  "\020transaction_time\030\005 \001(\004\022\026\n\016order_quantit"
  "y\030\006 \001(\001\022\036\n\norder_type\030\007 \001(\0162\n.OrderType\022"
  "\022\n\005price\030\010 \001(\001H\000\210\001\001B\010\n\006_price* \n\tDirecti"
  "on\022\010\n\004LONG\020\000\022\t\n\005SHORT\020\001*\"\n\tOrderType\022\n\n\006"
  "MARKET\020\000\022\t\n\005LIMIT\020\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_trademessage_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_trademessage_2eproto = {
    false, false, 307, descriptor_table_protodef_trademessage_2eproto,
    "trademessage.proto",
    &descriptor_table_trademessage_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_trademessage_2eproto::offsets,
    file_level_metadata_trademessage_2eproto, file_level_enum_descriptors_trademessage_2eproto,
    file_level_service_descriptors_trademessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_trademessage_2eproto_getter() {
  return &descriptor_table_trademessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_trademessage_2eproto(&descriptor_table_trademessage_2eproto);
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Direction_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_trademessage_2eproto);
  return file_level_enum_descriptors_trademessage_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* OrderType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_trademessage_2eproto);
  return file_level_enum_descriptors_trademessage_2eproto[1];
}
...
// @@protoc_insertion_point(message_clear_start:NewOrderMessage)
  ...
  ::memset(&_impl_.order_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.order_quantity_) -
      reinterpret_cast<char*>(&_impl_.order_id_)) + sizeof(_impl_.order_quantity_));
  _impl_.price_ = 0;
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 49)) {
          _impl_.order_quantity_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* NewOrderMessage::_InternalSerialize(
  ...
  double tmp_order_quantity = this->_internal_order_quantity();
  uint64_t raw_order_quantity;
  memcpy(&raw_order_quantity, &tmp_order_quantity, sizeof(tmp_order_quantity));
  if (raw_order_quantity != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(6, this->_internal_order_quantity(), target);
  }
...
void NewOrderMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_order_quantity = from._internal_order_quantity();
  uint64_t raw_order_quantity;
  memcpy(&raw_order_quantity, &tmp_order_quantity, sizeof(tmp_order_quantity));
  if (raw_order_quantity != 0) {
...
::PROTOBUF_NAMESPACE_ID::Metadata NewOrderMessage::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_trademessage_2eproto_getter, &descriptor_table_trademessage_2eproto_once,
      file_level_metadata_trademessage_2eproto[0]);
}
