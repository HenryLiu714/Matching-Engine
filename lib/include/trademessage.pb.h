...
#ifndef GOOGLE_PROTOBUF_INCLUDED_trademessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_trademessage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_trademessage_2eproto
...
struct TableStruct_trademessage_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_trademessage_2eproto;
...
class NewOrderMessage final :
 ...
 public:
  ...
  void set_order_quantity(double value);
  private:
  double _internal_order_quantity() const;
  void _internal_set_order_quantity(double value);
  public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_trademessage_2eproto;
};
// ===================================================================
...
inline double NewOrderMessage::_internal_order_quantity() const {
  return _impl_.order_quantity_;
}
inline double NewOrderMessage::order_quantity() const {
  // @@protoc_insertion_point(field_get:NewOrderMessage.order_quantity)
  return _internal_order_quantity();
}
inline void NewOrderMessage::_internal_set_order_quantity(double value) {
  
  _impl_.order_quantity_ = value;
}
inline void NewOrderMessage::set_order_quantity(double value) {
...
inline double NewOrderMessage::_internal_price() const {
  return _impl_.price_;
}
inline double NewOrderMessage::price() const {
  // @@protoc_insertion_point(field_get:NewOrderMessage.price)
  return _internal_price();
}
inline void NewOrderMessage::_internal_set_price(double value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.price_ = value;
}
inline void NewOrderMessage::set_price(double value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_trademessage_2eproto
